...
Write-Output "Phase-4d [INFO] Zeroing out empty space..."
 $startDTM = (Get-Date)
 $FilePath="c:\zero.tmp"
 ...
 $endDTM = (Get-Date)
 Write-Output "Phase 4d [INFO] Zeroing took: $(($endDTM-$startDTM).totalseconds) seconds"

Write-Output "Phase-4d [END]"
exit 0